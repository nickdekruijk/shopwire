...
class CreateDiscountsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create(config('shopwire.table_prefix') . 'discounts', function (Blueprint $table) {
            ...
            $table->integer('uses_per_code')->nullable();
    ...
    {
        Schema::dropIfExists(config('shopwire.table_prefix') . 'discounts');
    }
}
